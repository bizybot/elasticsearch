...
/**
 * The {@code ManageApplicationPrivileges} privilege is a {@link GlobalConfigurableClusterPrivilege} that grants the
 ...
 */
public class ManageApplicationPrivileges implements GlobalConfigurableClusterPrivilege {
    ...
    public Automaton automaton() {
        return Automatons.patterns("cluster:admin/xpack/security/privilege/*");
    }
