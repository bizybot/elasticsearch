    ...
    public void testCreateAndUpdateRole() {
        ...
        if (authenticate) {
            ...
            assertTrue("any cluster permission should be authorized",
                    Role.builder(getRolesResponse.roles()[0], null).build().cluster().check("cluster:admin/foo", request, authn));
            ...
            assertFalse("no cluster permission should be authorized",
                    Role.builder(getRolesResponse.roles()[0], null).build().cluster().check("cluster:admin/bar", request, authn));
        }
    }
